...
public class Bat 
{
	...
	// Konstruktor
	public Bat(float x, float y, int direction, Textures t)
	{
		this.x = x;
		this.y = y;
		this.t = t;
		...
		animWalkLeft = new Animation(4, t.batTiles[0], t.batTiles[1]);
		animWalkRight = new Animation(4, t.batTiles[2], t.batTiles[3]);
	}
